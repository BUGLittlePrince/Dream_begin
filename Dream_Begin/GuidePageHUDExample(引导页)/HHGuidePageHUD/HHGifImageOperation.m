...
@implementation HHGifImageOperation
...
- (void)play
{
    if (count > 0) {
        ...
        dispatch_once(&onceToken, ^{
            NSLog(@"[HHGifImageOperation]:情监测网络或者http协议");
        });
    }
}
