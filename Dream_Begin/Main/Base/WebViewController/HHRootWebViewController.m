...
@interface HHRootWebViewController ()<WKNavigationDelegate>
...
@implementation HHRootWebViewController
...
- (void)updateNavigationItems
{
    if (_isShowCloseBtn) {
        if (self.webView.canGoBack) {
            ...
            if (kiOS9Later) {
                [self addNavigationItemWithImageNames:@[@"back_icon"] isLeft:YES target:self action:@selector(leftBtnClick:) tags:@[@2000]];
            }
        }
    }
}
