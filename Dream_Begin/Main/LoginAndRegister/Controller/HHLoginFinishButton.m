...
@implementation HHLoginFinishButton
...
-(void)clickAnimation{
    ...
    _clickCircleLayer = clickCicrleLayer;
...
-(void)clickNextAnimation{
    ...
    _clickCircleLayer.strokeColor = [UIColor whiteColor].CGColor;
