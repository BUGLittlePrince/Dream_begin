...
#import "HHFourPingTransition.h"

@implementation HHFourPingTransition
...
{
    switch (_type) {
        case HHPresentOneTransitionTypePresent:
            [self presentAnimation:transitionContext];
            break;
        case HHPresentOneTransitionTypeDismiss:
