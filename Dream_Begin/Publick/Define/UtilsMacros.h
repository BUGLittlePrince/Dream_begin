...
//登录
#define isLogin [HHUserManager sharedHHUserManager].isLogined
#define curUser [HHUserManager sharedHHUserManager].curUserInfo
#define userManager [HHUserManager sharedHHUserManager]
